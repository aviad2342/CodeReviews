...
public class StarRater extends JPanel {
   ...
   */
  public StarRater(int stars, int rating) {
    this(stars, rating, 0);
  }
   ...
   */
  public StarRater(int stars, int rating, int selection) {
    this.stars = stars;
    this.rating = rating;
    ...
    addMouseListener(new MouseAdapter() {
      ...
      public void mousePressed(MouseEvent event) {
        if (isEnabled()) {
          ...
          int select= 1 + (event.getX() / STAR_BACKGROUND_IMAGE.getWidth(null));
          if(select== StarRater.this.selection)
          {
              StarRater.this.selection=0;
              secondPick=true;
          }
          else
          {
          StarRater.this.selection =select;  
          }
